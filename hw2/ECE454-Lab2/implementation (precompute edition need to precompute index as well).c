...
void processAll( struct _three_byte_* r,struct info** info_array_array,int obj_size , unsigned width, unsigned height,
                               int x, int y,int rotate_iteration,int mirror_x, int mirror_y) {
//    printf("here1\n");
//
//        printf("here1");
...
//             printf("%d:test\n",info_array_array[0][0].color);
             ...
             if(rotate&&mirror_x){
                ...
                post_shifth = shifthorizontal;
                 ...
                 memset(f,white,size);  
                processAll(f,info_array_array,info_index,width,height,post_shifth,post_shiftv,rotate,mirror_x,mirror_y);
//                 memset(r,white,size);
