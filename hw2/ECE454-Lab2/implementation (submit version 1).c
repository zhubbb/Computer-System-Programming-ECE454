...
void processAll(unsigned char *buffer_frame, unsigned width, unsigned height,
...
//             printf("%d:test\n",(-13%4));
            ...
            processAll(frame_buffer,width,height,shifthorizontal,shiftvertical,rotate,mirror_x,mirror_y);
