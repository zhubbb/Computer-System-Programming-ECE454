...
//        int index=0;
        ...
        char * white_buffer = (char *)malloc(row_size);
        memset(white_buffer,white,row_size);
        for(int i=0;i< height;++i ){
            int index=i*width;
            
            if(memcmp(&f[index],white_buffer,row_size)){
