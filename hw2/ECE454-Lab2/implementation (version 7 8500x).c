...
//    printf("%d w,%d h",width,height);
    ...
    #define for_looper(statement) for(int i =0 ; i < obj_size; ++i){\
        struct info inf = info_array[i];\
        int v1=inf.y-y, h1=inf.x+x;\
        int v2,h2;\
        statement(v1,h1,width,v2,h2);\
    ...
    if(rotate_iteration){
        if(mirror_x){
            switch(rotate_iteration){
                case 1: for_looper(rotate_90_mirror_x); break;
                case 2: for_looper(rotate_180_mirror_x); break;
                case 3: for_looper(rotate_270_mirror_x); break;
            }
        }else if(mirror_y){
            switch(rotate_iteration){
                case 1: for_looper(rotate_90_mirror_y); break;
                case 2: for_looper(rotate_180_mirror_y); break;
                case 3: for_looper(rotate_270_mirror_y); break;
            }

        }else{
            switch(rotate_iteration){
                case 1: for_looper(rotate_90); break;
                case 2: for_looper(rotate_180); break;
                case 3: for_looper(rotate_270); break;
            }
