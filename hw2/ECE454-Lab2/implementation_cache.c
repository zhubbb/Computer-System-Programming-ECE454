...
//frame caching
unsigned char *frame_cache[16] ={NULL};
struct state frame_state[16] = {{.shifthorizontal=0,.shiftvertical=0,.rotate=0,.mirror_x=0,.mirror_y=0}};
int frame_index=0;
...
//        char rendered_buffer[width*height*3];
            ...
            int white = 0xffffff;
//            for(int i=0;i<16&&frame_cache[0]==NULL;i++){
//                
//                frame_cache[i]= malloc(size);
//                memset(frame_cache[i],0xffffff,size);                
//            }
