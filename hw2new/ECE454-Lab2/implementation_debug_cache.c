...
//    void(*fptr)(int,int,int,int*,int*);
    ...
    if(rotate_iteration){
        if(mirror_x){
            ...
            switch(rotate_iteration){
                case 1: for_looper2(rotate_90);printf("info_r90_lopper:%d,%d\n",info_array_modified[0].index,info_array_modified[1].index);
...
char w[width*height*3];
memset(w,0xff,width*height*3);
	printf("proce: %d\n",memcmp(r,w,width*height*3));
printf("proce rotate: %d\n",rotate_iteration);
printf("proce shfit x, y : %d ,%d\n",x,y);
printf("proce mx: %d\n",mirror_x);
printf("proce my: %d\n",mirror_y);
printf("info ar: %d\n",info_array[0].color);
printf("r: %d\n",r[info_array[0].index-y*width+x]);
}
...
//        char rendered_buffer[width*height*3];
            ...
            for(int i=0;i<cache_size&&frame_cache[i]==NULL;i++){
                ...
                if(i==0){
                    memcpy(frame_cache[0],frame_buffer,size);
                }
            }
...
//                 memset(r,white,size);
  ...
  printf("info:%d,%d\n",info_array[0].index,info_array[0].color);
//printf("info_r90:%d,%d\n",info_array_r90[0].index,info_array_r90[1].index);
//printf("info_r180:%d,%d\n",info_array_r180[0].index,info_array_r180[1].index);
