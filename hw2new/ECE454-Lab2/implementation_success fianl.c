...
printf("%d\n",found);
             ...
             if(rotate&&mirror_x){
                ...
                post_shifth = shifthorizontal;
                 ...
                 memset(frame_cache[frame_index],0xff,size);  
//                processAll(frame_buffer,info_array,info_index,width,height,shifthorizontal,shiftvertical,rotate,mirror_x,mirror_y);
 		...
 		frame_state[frame_index].shiftvertical= shiftvertical;
               ...
               frame_state[frame_index].mirror_y= mirror_y;
                  processAll2((struct _three_byte_*)frame_cache[frame_index],info_array_array,info_index,width,height,post_shifth,post_shiftv,rotate,mirror_x,mirror_y);
//                 memset(r,white,size);

printf("framei cache : %d\n",frame_cache[frame_index]);
printf("framei index : %d\n",frame_index);
