...
//            printf("wrong\n");
    ...
    for(;curgen<gens_max;curgen++){
        ...
        update_row_parallel_upperself(nrows,ncols,upperi2,buffer1,buffer2,upper_lock_self,1);
        size2=0;
        coord current = head;
        ...
        update_row_parallel_lowerself(nrows,ncols,loweri2,buffer1,buffer2,lower_lock_self,0);
        if(lower_bound){
